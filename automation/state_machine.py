...
TRANSITIONS: Dict[TaskState, List[TaskState]] = {
    ...
    TaskState.VALIDATING: [TaskState.TESTING, TaskState.BUILDING, TaskState.DB_VERIFY, TaskState.PREVIEW_DEPLOY, TaskState.UI_VERIFY, TaskState.READY_TO_COMMIT, TaskState.REVISING, TaskState.PAUSED],
    ...
    TaskState.DB_VERIFY: [TaskState.REVIEWING, TaskState.REVISING, TaskState.VALIDATING, TaskState.PAUSED],
    TaskState.PREVIEW_DEPLOY: [TaskState.REVIEWING, TaskState.REVISING, TaskState.VALIDATING, TaskState.PAUSED],
    TaskState.UI_VERIFY: [TaskState.REVIEWING, TaskState.REVISING, TaskState.VALIDATING, TaskState.PAUSED],
    TaskState.REVIEWING: [TaskState.READY_TO_COMMIT, TaskState.REVISING, TaskState.VALIDATING, TaskState.NEED_USER_DECISION, TaskState.WAITING_FOR_QUOTA, TaskState.FAILED_STALLED, TaskState.PAUSED],
    ...
    TaskState.WAITING_FOR_USER_APPROVAL: [TaskState.APPROVED_TO_COMMIT, TaskState.REJECTED_BY_USER, TaskState.COMMITTED, TaskState.FAILED_STALLED, TaskState.NEED_USER_DECISION, TaskState.PAUSED],
    ...
    TaskState.COMMITTED: [TaskState.PUSHED],
